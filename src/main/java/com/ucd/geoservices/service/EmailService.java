...
public class EmailService {
	...
	public void sendEmailWithImage(User user, Location parkingLocation,
		...
		content += "\r\n";
		content += "Coordinates : "
				+ parkingLocation.getCoordinates().getLongitude() + " , "
				+ parkingLocation.getCoordinates().getLatitude() + "";
		content += "\r\n";
		content += "Regards";
		content += "\r\n";
		content += user.getUsername();
		emailProvider.send(user.getEmail(), "marcocast@gmail.com",
				"Report Parking Violation", content, img, fileName);
